...
mkdir -p "/Users/user/grails/eclipse-cpvars"
cd "/Users/user/grails/eclipse-cpvars"
ln -s "/Users/user/.ivy2/cache" "GRAILS_IVYCACHE"
ln -s "/Users/user/.grails/1.3.6" "GRAILS_WORKDIR"
